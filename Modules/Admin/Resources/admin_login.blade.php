...
<link href="{{asset('theme_admin/css/font-awesome.css') }}" rel="stylesheet"> 
<!-- //font-awesome icons -->
<script src="{{asset('theme_admin/js/jquery2.0.3.min.j') }}s"></script>
</head>
<body>
<div class="log-w3">
...
<script src="{{asset('theme_admin/js/jquery.nicescroll.js') }}"></script>
